 ...
 */
@Stateless
public class CredencialGradeHorariaFacade extends AbstractFacade<CredencialGradeHoraria> {
    ...
    public CredencialGradeHorariaFacade() {
        super(CredencialGradeHoraria.class);
    }
